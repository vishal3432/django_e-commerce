...
#define __PYX_HAVE__shop__recommender
#define __PYX_HAVE_API__shop__recommender
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "shop.recommender" */
...
#define __Pyx_MODULE_NAME "shop.recommender"
extern int __pyx_module_is_main_shop__recommender;
int __pyx_module_is_main_shop__recommender = 0;

/* Implementation of "shop.recommender" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_4shop_11recommender_get_similarity_scores(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_user_vector, PyArrayObject *__pyx_v_product_matrix); /* proto */
...
#define __pyx_kp_u_shop_recommender_pyx __pyx_string_tab[5]
...
#define __pyx_n_u_get_similarity_scores __pyx_string_tab[11]
...
#define __pyx_n_u_num_features __pyx_string_tab[20]
#define __pyx_n_u_num_products __pyx_string_tab[21]
#define __pyx_n_u_numpy __pyx_string_tab[22]
#define __pyx_n_u_pop __pyx_string_tab[23]
#define __pyx_n_u_product_matrix __pyx_string_tab[24]
#define __pyx_n_u_qualname __pyx_string_tab[25]
#define __pyx_n_u_scores __pyx_string_tab[26]
#define __pyx_n_u_set_name __pyx_string_tab[27]
#define __pyx_n_u_setdefault __pyx_string_tab[28]
#define __pyx_n_u_shop_recommender __pyx_string_tab[29]
#define __pyx_n_u_test __pyx_string_tab[30]
#define __pyx_n_u_user_vector __pyx_string_tab[31]
#define __pyx_n_u_values __pyx_string_tab[32]
#define __pyx_n_u_zeros __pyx_string_tab[33]
#define __pyx_kp_b_iso88591_N_N_6RvQa_U_1_a_E_aq_as_N_3a_au __pyx_string_tab[34]
...
/* Python wrapper */
static PyObject *__pyx_pw_4shop_11recommender_1get_similarity_scores(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_4shop_11recommender_1get_similarity_scores = {"get_similarity_scores", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4shop_11recommender_1get_similarity_scores, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4shop_11recommender_1get_similarity_scores(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyArrayObject *__pyx_v_product_matrix = 0;
  #if !CYTHON_METH_FASTCALL
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_similarity_scores (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_user_vector,&__pyx_mstate_global->__pyx_n_u_product_matrix,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "get_similarity_scores", 0) < (0)) __PYX_ERR(0, 6, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("get_similarity_scores", 1, 2, 2, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
    ...
    __pyx_v_product_matrix = ((PyArrayObject *)values[1]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_similarity_scores", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("shop.recommender.get_similarity_scores", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_user_vector), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "user_vector", 0))) __PYX_ERR(0, 6, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_product_matrix), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "product_matrix", 0))) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_r = __pyx_pf_4shop_11recommender_get_similarity_scores(__pyx_self, __pyx_v_user_vector, __pyx_v_product_matrix);
...
static PyObject *__pyx_pf_4shop_11recommender_get_similarity_scores(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_user_vector, PyArrayObject *__pyx_v_product_matrix) {
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_product_matrix;
  __Pyx_Buffer __pyx_pybuffer_product_matrix;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_similarity_scores", 0);
  ...
  __pyx_pybuffer_product_matrix.pybuffer.buf = NULL;
  __pyx_pybuffer_product_matrix.refcount = 0;
  __pyx_pybuffernd_product_matrix.data = NULL;
  __pyx_pybuffernd_product_matrix.rcbuffer = &__pyx_pybuffer_product_matrix;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_user_vector.rcbuffer->pybuffer, (PyObject*)__pyx_v_user_vector, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_product_matrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_product_matrix, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
  __pyx_pybuffernd_product_matrix.diminfo[0].strides = __pyx_pybuffernd_product_matrix.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_product_matrix.diminfo[0].shape = __pyx_pybuffernd_product_matrix.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_product_matrix.diminfo[1].strides = __pyx_pybuffernd_product_matrix.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_product_matrix.diminfo[1].shape = __pyx_pybuffernd_product_matrix.rcbuffer->pybuffer.shape[1];

  /* "shop/recommender.pyx":10
 * 
 *     cdef int i, j
 ...
 * 
*/
  __pyx_v_num_products = (__pyx_f_5numpy_7ndarray_5shape_shape(((PyArrayObject *)__pyx_v_product_matrix))[0]);

  /* "shop/recommender.pyx":11
 *     cdef int i, j
 *     cdef int num_products = product_matrix.shape[0]
 *     cdef int num_features = product_matrix.shape[1]             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_v_num_features = (__pyx_f_5numpy_7ndarray_5shape_shape(((PyArrayObject *)__pyx_v_product_matrix))[1]);

  /* "shop/recommender.pyx":14
 * 
 *     # Result store karne ke liye array
...
*/
  ...
  __pyx_t_3 = __Pyx_PyLong_From_int(__pyx_v_num_products); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = 1;
...
*/
  __pyx_t_6 = __pyx_v_num_products;
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "shop/recommender.pyx":18
 *     # Heavy calculation loop - Cython isse C ki speed pe chalayega
 *     for i in range(num_products):
 *         dot_product = 0             # <<<<<<<<<<<<<<
 *         for j in range(num_features):
...
*/
    ...
    __Pyx_XDECREF_SET(__pyx_v_dot_product, __pyx_mstate_global->__pyx_int_0);

    /* "shop/recommender.pyx":19
 *     for i in range(num_products):
 *         dot_product = 0
 *         for j in range(num_features):             # <<<<<<<<<<<<<<
 *             dot_product += user_vector[j] * product_matrix[i, j]
...
*/
    __pyx_t_9 = __pyx_v_num_features;
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_j = __pyx_t_11;

      /* "shop/recommender.pyx":20
 *         dot_product = 0
 *         for j in range(num_features):
 *             dot_product += user_vector[j] * product_matrix[i, j]             # <<<<<<<<<<<<<<
 *         scores[i] = dot_product
...
*/
      ...
      __pyx_t_13 = -1;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_pybuffernd_user_vector.diminfo[0].shape;
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_user_vector.diminfo[0].shape)) __pyx_t_13 = 0;
      ...
      __pyx_t_13 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_pybuffernd_product_matrix.diminfo[0].shape;
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_product_matrix.diminfo[0].shape)) __pyx_t_13 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_pybuffernd_product_matrix.diminfo[1].shape;
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_13 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_pybuffernd_product_matrix.diminfo[1].shape)) __pyx_t_13 = 1;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_1 = PyFloat_FromDouble(((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_user_vector.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_user_vector.diminfo[0].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_product_matrix.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_product_matrix.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_product_matrix.diminfo[1].strides)))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_4 = PyNumber_InPlaceAdd(__pyx_v_dot_product, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF_SET(__pyx_v_dot_product, __pyx_t_4);
      __pyx_t_4 = 0;
    }

    /* "shop/recommender.pyx":21
 *         for j in range(num_features):
 *             dot_product += user_vector[j] * product_matrix[i, j]
 *         scores[i] = dot_product             # <<<<<<<<<<<<<<
 * 
 *     return scores
*/
    __pyx_t_16 = __Pyx_PyFloat_AsDouble(__pyx_v_dot_product); if (unlikely((__pyx_t_16 == ((npy_float64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L1_error)
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_9 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_pybuffernd_scores.diminfo[0].shape;
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_pybuffernd_scores.diminfo[0].shape)) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 21, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_scores.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_scores.diminfo[0].strides) = __pyx_t_16;
  }

  /* "shop/recommender.pyx":23
 *         scores[i] = dot_product
 * 
 *     return scores             # <<<<<<<<<<<<<<
*/
...
*/
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_product_matrix.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_recommender(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_recommender},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_recommender(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_recommender(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_recommender(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'recommender' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "recommender" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_recommender", 0);
  ...
  if (__pyx_module_is_main_shop__recommender) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "shop.recommender")) {
      if (unlikely((PyDict_SetItemString(modules, "shop.recommender", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4shop_11recommender_1get_similarity_scores, 0, __pyx_mstate_global->__pyx_n_u_get_similarity_scores, NULL, __pyx_mstate_global->__pyx_n_u_shop_recommender, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_get_similarity_scores, __pyx_t_2) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "shop/recommender.pyx":1
 * # shop/recommender.pyx             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as cnp
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init shop.recommender", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init shop.recommender");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{39},{34},{20},{20},{18},{18},{11},{8},{21},{1},{13},{5},{1},{8},{10},{8},{2},{12},{12},{5},{3},{14},{12},{6},{12},{10},{16},{8},{11},{6},{5},{101}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd